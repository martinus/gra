---
name: gra
description: 'Use when working with gra, the Git Repo Admin CLI: clone repositories, list or open worktrees, create reusable worktrees, clean safe worktrees, inspect gra root layout, or explain gra commands.'
...
- `safe`: clean worktree whose `HEAD` is merged into origin's default branch.
